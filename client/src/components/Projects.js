...
<section className="project" id="projects">
    ...
    <Row>
        ...
        <TrackVisibility>
            ...
            <h2>PROJECTS</h2>
            <p >I'm thrilled to present my portfolio, showcasing a diverse range of projects developed using both Python full-stack and MERN (MongoDB, Express.js, React, Node.js) full-stack technologies. These projects reflect my proficiency in building scalable and innovative web applications, whether it's harnessing Python's versatility or the robustness of the MERN stack. Explore the amalgamation of my skills and creativity in crafting solutions that empower users and drive engagement.</p>
